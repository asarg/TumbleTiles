...
emptyBoardFile = "Examples/newempty.xml"
...
def logStartingCoordinates():
	...
	for x in range(0,1000):
	    ...
	    if coordString not in redSet:
	        ...
	        if not tileMoved:
	        	redPath1Set.add(coordString)
	        else:
	        	redPath2Set.add(coordString)
	...
	print("redPath1Set size: ", len(redPath1Set))
	print("redPath2Set size: ", len(redPath2Set))
...
def stateDidNotChange(startingPosition):
	global redPath1Set
	global redPath2Set

	if startingPosition[:4] == solution:
		if solution == blueStartN and startingPosition[4:8] in redPath2Set:
			return True
	 	if solution == blueStartE and startingPosition[4:8] in redPath2Set:
	 		return True
		if solution == blueStartW and startingPosition[4:8] in redPath1Set:
			return True
		if solution == blueStartS and startingPosition[4:8] in redPath1Set:
			return 

		# if solution == blueStartN and startingPosition[4:8] in redPath1Set:
		# 	return True
	 # 	if solution == blueStartE and startingPosition[4:8] in redPath1Set:
	 # 		return True
		# if solution == blueStartW and startingPosition[4:8] in redPath2Set:
		# 	return True
		# if solution == blueStartS and startingPosition[4:8] in redPath2Set:
		# 	return True
...
def blueLeaving(startingPosition, newPosition, direction):
	...
	# return False
	blueLeaving = False
	if newPosition[:4] == blueStartN and start == blueStartN:
		# print("Blue trying to leave!")
		blueLeaving = True
	elif newPosition[:4] == blueStartE and start == blueStartE:
		# print("Blue trying to leave!")
		blueLeaving = True
	elif newPosition[:4] == blueStartS and start == blueStartS:
		# print("Blue trying to leave!")
		blueLeaving = True
	elif newPosition[:4] == blueStartW and start == blueStartW:
		# print("Blue trying to leave!")
		blueLeaving = True
...
def recurseTree(root, startingPosition, direction):
	...
	if stateDidNotChange(startingPosition):
		newNode.stateDidNotChange = True
		brokenPositions.add(newNode)
